...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.verbose_link'
        db.delete_column('me_project', 'verbose_link')

        # Deleting field 'Project.verbose_link_text'
        db.delete_column('me_project', 'verbose_link_text')

        # Adding field 'ProjectTranslation.verbose_link'
        db.add_column('me_project_translation', 'verbose_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ProjectTranslation.verbose_link_text'
        db.add_column('me_project_translation', 'verbose_link_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.verbose_link'
        db.add_column('me_project', 'verbose_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Project.verbose_link_text'
        db.add_column('me_project', 'verbose_link_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'ProjectTranslation.verbose_link'
        db.delete_column('me_project_translation', 'verbose_link')

        # Deleting field 'ProjectTranslation.verbose_link_text'
        db.delete_column('me_project_translation', 'verbose_link_text')
